          ...
          sections: [{
            ...
            children: [
              ...
              new Paragraph({
                children: [
                  new TextRun({
                    text: "DISCLAIMER: This is a template document generated by the Dorf Nelson & Zauderer Legal Assistant. This document is for informational purposes only and does not constitute legal advice. Please consult with a qualified attorney before using this document.",
                    italics: true,
                    size: 18,
                  }),
                ],
